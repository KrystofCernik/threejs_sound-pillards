...
class ParticleSystem {
    ...
    update() {
        ...
        while (i < this.particleCount) {
            this.particlesGeom.attributes.position.array[i * 3 + 0] += 0.02
            this.particlesGeom.attributes.position.array[i * 3 + 1] += 0.02
            ...
            if (this.particlesGeom.attributes.position.array[i * 3 + 0] > this.boxSize / 2) {
                this.particlesGeom.attributes.position.array[i * 3 + 0] = - this.boxSize / 2
            }
            i++
        }
